...
pub fn query_coin_balance(deps: Deps<impl CustomQuery>, account_addr: &Addr, denom: String) -> Result<Uint256, NeptuneError> {
...
pub fn query_token_balance(deps: Deps<impl CustomQuery>, token_addr: &Addr, account_addr: &Addr) -> Result<Uint256, NeptuneError> {
...
pub fn query_supply(deps: Deps<impl CustomQuery>, contract_addr: &Addr) -> Result<Uint256, NeptuneError> {
...
pub fn query_asset_balance(deps: Deps<impl CustomQuery>, account: &Addr, asset: &AssetInfo) -> Result<Uint256, NeptuneError> {
    match asset {

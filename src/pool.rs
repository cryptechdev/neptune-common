...
impl Pool 
{
    ...
    pub fn into_ref(&mut self) -> PoolRef {
        PoolRef {
    ...
    pub fn increase_balance(&mut self, amount: Uint256) {
        self.into_ref().increase_balance(amount)
    }

    pub fn decrease_balance(&mut self, amount: Uint256) {
        self.into_ref().decrease_balance(amount)
    }
